...
export function InputTypeGroup({ name, titleLabel, type, placeholder, icon, textError, link, isError=true }: InputTypeGroupProps) {
    return (
        <div className="flex flex-col gap-y-1.5">
            ...
            {icon ?
                <InputField type={type} name={name} placeholder={placeholder} isError={textError && isError ? true : false} icons={{ IconAfterInput: icon.Icon, css: icon.css }} />
